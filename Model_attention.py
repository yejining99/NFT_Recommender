...
class MMMO(torch.nn.Module):
    def __init__(self, features, user_features, edge_index, batch_size, num_user, num_item, reg_parm, dim_x, path=None, cluster_dict=None):
        ...
        self.v_gnn = GAT(self.v_feat, self.user_features, self.edge_index, batch_size, num_user, num_item, dim_x, dim_latent=1024)
        self.t_gnn = GAT(self.t_feat, self.user_features, self.edge_index, batch_size, num_user, num_item, dim_x, dim_latent=1800)
        self.p_gnn = GAT(self.p_feat, self.user_features, self.edge_index, batch_size, num_user, num_item, dim_x, dim_latent=64)
        self.tr_gnn = GAT(self.tr_feat, self.user_features, self.edge_index, batch_size, num_user, num_item, dim_x, dim_latent=64)
...
class GRAPH(torch.nn.Module):
    def __init__(self, features, user_features, edge_index, batch_size, num_user, num_item, reg_parm, dim_x, path=None, cluster_dict=None):
        ...
        self.gnn = GAT(self.feat, self.user_features, self.edge_index, batch_size, num_user, num_item, dim_x, dim_latent=1800)
...
class GAT(torch.nn.Module):
    def __init__(self, features, user_features, edge_index, batch_size, num_user, num_item, dim_id, dim_latent=None):
